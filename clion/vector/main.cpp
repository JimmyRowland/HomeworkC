...
int main()
{
    ...
    cout << "Capacity of the Vector : " << vector.capacity() << endl;
    cout << "Size of the Vector :" << vector.size() << endl;
    ...
    cout << "Size of the Vector after resize method calling : " << vector.size() << endl;
