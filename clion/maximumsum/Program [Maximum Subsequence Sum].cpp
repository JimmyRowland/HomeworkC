...
int main()
{
    srand(450);	// Initialize random seed
    ...
    cout << "Brute Force Solution: O(n3) " << maxSequenceSum_N3(A, 100) << endl;
    cout << "Better Solution: O(n2) " << maxSequenceSum_N2(A, 100) << endl;
    cout << "Optimal Solution: O(n1) " << maxSequenceSum_N1(A, 100) << endl << endl;
